...
namespace MP3Sharp.Support
{
	...
	internal class SupportClass
	{
		...
		public static void Serialize(System.IO.Stream stream, object objectToSend)
		{
			System.Runtime.Serialization.Formatters.Binary.BinaryFormatter formatter = new System.Runtime.Serialization.Formatters.Binary.BinaryFormatter();
		...
		/// <param name="objectToSend">The object to be sent</param>
		public static void Serialize(System.IO.BinaryWriter binaryWriter, object objectToSend)
		{
			System.Runtime.Serialization.Formatters.Binary.BinaryFormatter formatter = new System.Runtime.Serialization.Formatters.Binary.BinaryFormatter();
	    ...
	    internal class BackInputStream : System.IO.BinaryReader
		{
		    ...
		    public BackInputStream(System.IO.Stream streamReader, int size) : base(streamReader)
			{
				...
				//this.position = size;
				position = 0; // why would you not do that?
			}
